  ...
  return knex(TABLE_NAME).del()
    .then(function () {
      return knex(TABLE_NAME).insert([
        ...
        {
          id: 3,
          title: 'Pug keytar thundercats flannel edison bulb',
        ...
        {
          id: 6,
          title: ' Gochujang squid readymade etsy keffiyeh cred poutine',
        ...
        {
          id: 7,
          title: 'Chambray pour-over celiac, lumbersexual synth',
